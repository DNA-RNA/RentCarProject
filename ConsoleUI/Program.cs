...
namespace ConsoleUI
{
    class Program
    {
        ...
        private static void CarTestDTOs()
        {
        ...
        static void GetCarByColorId()
        {
            ...
            foreach (var cars in carManager.GetCarsByColorId(renkSecim).Data)
            {
        ...
        static void GetCarByBrandId()
        {
            ...
            foreach (var cars in carManager.GetCarsByBrandId(markaSecim).Data)
            {
                Console.WriteLine(cars.Description);
            }
        }
